...
/*
    ...
    1. ERC20Proxied: The underlying token, state modifications must be made through a proxy
    2. TokenProxy: Proxy contract, appends the original msg.sender to any calldata provided by the user

    The ERC20Proxied can have many trusted frontends (TokenProxy's).
    The frontends should append the address of their caller to calldata when calling into the backend.
    Admin users of the ERC20Proxied can add new delegators.
*/

contract ERC20Proxied {
    // --- ERC20 Data ---
